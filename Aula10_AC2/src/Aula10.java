        ...
        for(int j = 0; j < quantidadeAlunos; j++){
            ...
            while(!notasCorretas){
                ...
                for(int i= 0; i < quantidadeNotas; i++){
                    ...
                    if(pesoTotal > 100){
                        System.out.println("O peso das notas desse aluno ultrapassa 100%, reinsira as notas deste aluno");
                        i = -1;
                        resetarVariaveis();
                        continue;
                    }
                ...
                // Perguntar ao usuário se deseja reinserir os dados
                System.out.println("Deseja reinserir os dados para o aluno atual? (s/n)");
